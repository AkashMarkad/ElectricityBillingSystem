...
public class Login extends JFrame implements ActionListener{
    ...
    public Login(){
        ...
        ImageIcon ic2 = new ImageIcon(ClassLoader.getSystemResource("icon/signup.png"));
        Image i2 = ic2.getImage().getScaledInstance(16, 16,Image.SCALE_DEFAULT);
        b2 = new JButton("Signup",new ImageIcon(i2));
        b2.setBounds(450, 160, 100, 20);
        b2.addActionListener(this);
        add(b2);

        ImageIcon ic4 = new ImageIcon(ClassLoader.getSystemResource("icon/cancel.jpg"));
        Image i4 = ic4.getImage().getScaledInstance(16, 16,Image.SCALE_DEFAULT);
        b3 = new JButton("Cancel",new ImageIcon(i4));
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            try{
                ...
                if(rs.next()){
                    String meter = String.valueOf(rs.getString("meter_no"));
