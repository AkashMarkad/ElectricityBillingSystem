...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == b1){
            ...
            String s7 = String.valueOf(t5.getText());

            try{
                Conn c = new Conn();
                c.s.executeUpdate("update customer set address = '"+s3+"', city = '"+s4+"', state = '"+s5+"', email = '"+s6+"', phone_no = '"+s7+"' where meter_no = '"+meter+"'");
