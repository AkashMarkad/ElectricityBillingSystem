        ...
        if (ae.getSource()== b1) {
            try {
                ...
                if (rs.next()) {
                    ...
                    t1.append("\n    Units Consumed:\t" + Float.parseFloat(rs.getString("units")));
                    t1.append("\n    Total Charges :\t" + Float.parseFloat(rs.getString("total_bill")));
                    t1.append("\n---------------------------------------------------------------");
                    t1.append("\n    TOTAL PAYABLE :\t" + Float.parseFloat(rs.getString("total_bill")));
                }
